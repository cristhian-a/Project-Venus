...
public final class ManagedTexture2 {
    ...
    public void draw(Graphics2D g, int dx, int dy, int dx2, int dy2, int sx, int sy, int sx2, int sy2) {
    ...
    public void draw(Graphics2D g, RenderQueue.SpriteTable table) {
        GraphicsConfiguration config = g.getDeviceConfiguration();
    ...
    private void validateVRAM(GraphicsConfiguration config) {
        // this is done with this strange if-else for atomicity reasons
